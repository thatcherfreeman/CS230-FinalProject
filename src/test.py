...
MODEL_DIR = "checkpoints/UNet_exp27/UNet_best_val.checkpoint"

combined = StftData(pickle_file = 'data/combined_1000.pkl')
biden = StftData(pickle_file='data/biden_1000.pkl')
trump = StftData(pickle_file='data/trump_1000.pkl')

container = StftData(pickle_file='data/combined_1000.pkl')
